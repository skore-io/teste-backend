...
describe('Contents Controller', () => {
  ...
  const validContent = new ContentInputData(1, "GOTO 2017 • The Many Meanings of Event-Driven Architecture • Martin Fowler", 3006, "youtube", "video", "STKCRSUsyP0", 1580428851394);
  ...
  describe('create content', ()=> {
    const expectedReturn = new Content(1, "GOTO 2017 • The Many Meanings of Event-Driven Architecture • Martin Fowler", 3006, "youtube", "video", "STKCRSUsyP0", 1580428851394);
    describe('success', () => {
